...
public:
  ...
  struct succ_op_iterator
      : iterator_adaptor_base<succ_op_iterator, op_iterator,
                              std::random_access_iterator_tag, BasicBlock *,
                              ptrdiff_t, BasicBlock *, BasicBlock *> {
    explicit succ_op_iterator(op_iterator I) : iterator_adaptor_base(I) {}
  ...
  struct const_succ_op_iterator
      : iterator_adaptor_base<const_succ_op_iterator, const_op_iterator,
                              std::random_access_iterator_tag,
                              const BasicBlock *, ptrdiff_t, const BasicBlock *,
                              const BasicBlock *> {
    explicit const_succ_op_iterator(const_op_iterator I)
...
public:
  ...
  LLVM_ABI iterator_range<const_succ_op_iterator> successors() const LLVM_READONLY;
  LLVM_ABI iterator_range<succ_op_iterator> successors() {
    ...
    return make_range(succ_op_iterator(Begin), succ_op_iterator(End));
  }
