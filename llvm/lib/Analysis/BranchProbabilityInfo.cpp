...
private:
  ...
  std::optional<uint32_t> getEstimatedLoopWeight(Cycle *C) const;
  ...
  SmallDenseMap<Cycle *, uint32_t> EstimatedLoopWeight;
};
...
std::optional<uint32_t>
BPIConstruction::getEstimatedLoopWeight(Cycle *C) const {
...
void BPIConstruction::estimateBlockWeights(const Function &F, DominatorTree *DT,
  ...
  SmallDenseMap<Cycle *, SmallVector<BasicBlock *, 4>> LoopExitBlocks;
