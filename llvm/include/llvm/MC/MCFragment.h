...
protected:
  MCEncodedFragmentWithFixups(MCFragment::FragmentType FType,
                              bool HasInstructions,
                              MCSection *Sec)
      : MCEncodedFragmentWithContents(FType, HasInstructions, Sec) {}
...
public:
  MCDataFragment(MCSection *Sec = nullptr)
      : MCEncodedFragmentWithFixups<4>(FT_Data, false, Sec) {}
...
/// consumption.
///
class MCCompactEncodedInstFragment : public MCEncodedFragmentWithContents {
public:
...
public:
  MCLEBFragment(const MCExpr &Value, bool IsSigned, MCSection *Sec = nullptr)
      : MCEncodedFragmentWithFixups<0>(FT_LEB, false, Sec),
        IsSigned(IsSigned), Value(&Value) {
    // FIXME: hack
    setContents(0, 1); // data doesn't matter.
...
public:
  MCDwarfLineAddrFragment(int64_t LineDelta, const MCExpr &AddrDelta,
                          MCSection *Sec = nullptr)
      : MCEncodedFragmentWithFixups<1>(FT_Dwarf, false, Sec),
...
public:
  MCDwarfCallFrameFragment(const MCExpr &AddrDelta, MCSection *Sec = nullptr)
      : MCEncodedFragmentWithFixups<1>(FT_DwarfFrame, false, Sec),
        AddrDelta(&AddrDelta) {}
...
public:
  MCCVDefRangeFragment(
      ...
      : MCEncodedFragmentWithFixups<4>(FT_CVDefRange, false, Sec),
...
public:
  MCPseudoProbeAddrFragment(const MCExpr *AddrDelta, MCSection *Sec = nullptr)
      : MCEncodedFragmentWithFixups<1>(FT_PseudoProbe, false, Sec),
        AddrDelta(AddrDelta) {}
