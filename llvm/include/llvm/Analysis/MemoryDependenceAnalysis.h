...
private:
  ...
  /// Visited map for getNonLocalPointerDependency. Stored here to reuse
  /// allocations. Map from block number to Value; second value is epoch to
  /// avoid clearing the vector.
