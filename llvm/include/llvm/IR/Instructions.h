...
public:
  ...
  iterator_range<const_succ_op_iterator> successors() const {
    return make_range(const_succ_op_iterator(
                          std::next(op_begin(), isConditional() ? 1 : 0)),
...
public:
  ...
  iterator_range<succ_op_iterator> successors() {
    ...
    return {succ_op_iterator(First), succ_op_iterator(op_end())};
  }
  iterator_range<const_succ_op_iterator> successors() const {
    const Use *First = &Op<-1>() - getNumIndirectDests() - 1;
    return {const_succ_op_iterator(First), const_succ_op_iterator(op_end())};
  }
...
public:
  ...
  iterator_range<succ_op_iterator> successors() {
    return {succ_op_iterator(std::next(op_begin())), succ_op_iterator(op_end())};
  }
  iterator_range<const_succ_op_iterator> successors() const {
    return {const_succ_op_iterator(std::next(op_begin())), const_succ_op_iterator(op_end())};
  }
