...
public:
  ...
  /// getBlockNumberEpoch() - Return the numbering "epoch" of block numbers,
  /// incremented after each numbering. Intended for asserting that no
  /// renumbering was performed when used by, e.g., preserved analyses.
